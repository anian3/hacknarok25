...
const SubHeader = ({
  ...
  const renderButton = (section: "Forum" | "Jobs" | "Artists") => {
    ...
    // Keep desktop the same with responsive changes for mobile only
    const baseClasses =
      "px-4 md:px-25 py-2 text-base md:text-lg cursor-pointer rounded-full transition-colors duration-300 ease-in-out";
